...
(function () {
  ...
  var S = {
    ...
    maintSub: "report", mtDraft: {}, infoMode: false,
  };
  ...
  /* ---------- views ---------- */
  function login() {
    return '<div class="login"><div class="login-head"><span class="bm" style="width:46px;height:46px;font-size:23px">' + I("helmet") + '</span><h3>Storage Depot</h3><p class="hint" style="text-align:center;margin:0">Sign in to your portal</p></div>'
  ...
  function maintenanceHome() {
    ...
    var nav = '<div class="tabs"><button class="' + (sub === "report" ? "on" : "") + '" data-a="mtsub" data-k="report">Report a problem</button><button class="' + (sub === "reported" ? "on" : "") + '" data-a="mtsub" data-k="reported">Reported problems (' + allItems.length + ")</button></div>";
    var body;
    if (sub === "reported") {
      ...
      var d = S.mtDraft || {};
      var facOpts = '<option value="">— pick a facility —</option>' + S.facilities.map(function (f) { return '<option value="' + f.id + '"' + (d.facilityId === f.id ? " selected" : "") + ">" + esc(f.name) + "</option>"; }).join("");
      body = '<div class="card"><p class="hint" style="margin:0 0 8px">Report a maintenance problem without leaving this page.</p>'
  ...
  document.addEventListener("change", function (ev) {
    ...
    if (t.getAttribute("data-mtfac") !== null) { S.mtDraft = S.mtDraft || {}; S.mtDraft.facilityId = t.value; render(); return; }
  ...
  document.addEventListener("click", function (ev) {
    ...
    if (a === "mtsub") { S.maintSub = k; render(); return; }
    ...
    if (a === "mtsubmit") {
      ...
      putFacility(mf).then(function () { S.mtDraft = {}; S.maintSub = "reported"; toast("Problem reported."); render(); }).catch(function (e) { toast(e.message); });
      return;
    }
