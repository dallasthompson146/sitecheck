...
(function () {
  ...
  function leadAddForm() {
    ...
    var resv = d.kind === "reservation" ? '<div class="card">' + leadTog("Was the reservation put into Cubby?", "inCubby", d.inCubby) + leadTog("Was it a SpareFoot reservation?", "spareFoot", d.spareFoot) + leadTog("Did you inform the customer of all move-in discounts or promotions?", "informedDiscounts", d.informedDiscounts) + "</div>" : "";
